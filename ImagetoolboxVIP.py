    ...
    def Cornerdetection(self, num):
        ...
        if ret:
            ...
            #김나현
                ...
                qPixmapVar3=funcNahyun.CornerDetection(self.image_left)
                pass
            #김나현
    ...
    def Houghtransform(self, num):
        ...
        if ret:
            ...
            #김나현
                ...
                qPixmapVar3 = funcNahyun.Hough(self.image_left)
                pass
            #김나현
    ...
    def Edgedetection(self, num):
        ...
        if ret:
            ...
            #손정현
                ...
                qPixmapVar3 = funcJunghyun.EdgeDetection(self.image_left)
            #손정현
            ...
            #황승언
                ...
                qPixmapVar3=funcSeungeon.Edge_Detection(self.image_left)
                pass
            #황승언
